...
int main(int argc, char *argv[])
{
    ...
    for (int test_index = 0; test_index < 2; test_index++)
    {
        ...
        else // In test two, use htb
        {
            ...
            terminal.enter("tc class add dev eth1 parent 1:1 classid 1:10 htb rate 400kbit ceil 1600kbit\n");
            terminal.enter("tc class add dev eth1 parent 1:1 classid 1:20 htb rate 400kbit ceil 1600kbit\n");
            terminal.enter("tc class add dev eth1 parent 1:1 classid 1:30 htb rate 400kbit ceil 1600kbit\n");
            terminal.enter("tc class add dev eth1 parent 1:1 classid 1:40 htb rate 400kbit ceil 1600kbit\n");
