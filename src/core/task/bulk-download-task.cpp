...
BulkDownloadTask::BulkDownloadTask(quint16 serverPort, qint32 startTime, qint32 stopTime)
...
void BulkDownloadTask::setAttribute(const QString &attribute, const QString &value)
{
